...
# Install cockpit
sudo rpm-ostree install --assumeyes --allow-inactive git podman avahi samba smartmontools net-tools virt-manager cockpit cockpit-ws cockpit-system cockpit-ostree cockpit-storaged cockpit-networkmanager cockpit-selinux cockpit-navigator cockpit-machines cockpit-file-sharing
