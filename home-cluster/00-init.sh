...
# Install cockpit
sudo rpm-ostree install --assumeyes --allow-inactive git podman avahi samba smartmontools net-tools virt-manager cockpit-system cockpit-ostree cockpit-podman cockpit-storaged cockpit-networkmanager cockpit-machines cockpit-selinux cockpit-files
